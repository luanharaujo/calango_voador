...
static void __print_data(void)
{
        ...
        if(show_tb && enable_mag){
                ...
                printf("%lu,%f,%f,%f\n",   tempo, data.fused_TaitBryan[TB_PITCH_X]*RAD_TO_DEG,\
...
static void __print_header(void)
{
        ...
        if(enable_mag){
                ...
                if(show_tb) printf("Tempo(ms),X(Graus),Y(Graus),Z(Graus)\n0,1,1,1\n");
        } else{
...
int main(int argc, char *argv[])
{
        ...
        printf("\n");
        fflush(stdout);
        //printf("passei por aqui\n"); //funciona, mesmo quando encerrado com o sinal de crol+c programa passar por aqui
        return 0;
}